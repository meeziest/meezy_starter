...
class SgShimmerAnimationWidgetState extends State<SgShimmerAnimationWidget> with SingleTickerProviderStateMixin {
  ...
  void didChangeDependencies() {
    final syncController = ShimmerSyncer.of(context);
    isSynced = syncController != null;
    _controller = (syncController ?? AnimationController(vsync: this, duration: widget.animationDuration))
